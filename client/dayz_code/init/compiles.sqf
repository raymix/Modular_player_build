...
if (!isDedicated) then {
	...
	player_build_states =		compile preprocessFileLineNumbers "\z\addons\dayz_code\actions\player_build_playerStates.sqf";
	player_build_needNearby =	compile preprocessFileLineNumbers "\z\addons\dayz_code\actions\player_build_needNearby.sqf";
	player_build_getConfig =	compile preprocessFileLineNumbers "\z\addons\dayz_code\actions\player_build_getItemConfig.sqf";
	player_build_plotCheck =	compile preprocessFileLineNumbers "\z\addons\dayz_code\actions\player_build_plotpoleChecks.sqf";
	player_build_buildReq =		compile preprocessFileLineNumbers "\z\addons\dayz_code\actions\player_build_buildRequirements.sqf";
	player_build_create =		compile preprocessFileLineNumbers "\z\addons\dayz_code\actions\player_build_createObject.sqf";
	...
	//Snap building - disabled by default
	snap_build = 				compile preprocessFileLineNumbers "\z\addons\dayz_code\actions\snap_build.sqf";
	
	//mission file based configuration (overrides)
	if (DZE_customBuildSystem) then {
		DZE_customBuildInit = 	compile preprocessFileLineNumbers "custom\customBuildConfig.sqf";
	};
	//Modular player build
